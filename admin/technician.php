...
<div class="col-sm-9 col-md-10 mt-5 text-center">
    <p class="bg-dark text-white p-2">Technician List</p>
    <?php
                    ...
                    <?php
                        while($row=mysqli_fetch_array($result))
                        {
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['technician_city']; ?></td>
                                <td><?php echo $row['technician_mobile']; ?></td>
                                <td><?php echo $row['technician_email']; ?></td>
                                <td>
                                    <form action="edittechnician.php" class="d-inline" method="POST">
                                    ...
                                    <input type="hidden" name="id" value="<?php
                                    echo $row['technician_id']; ?>">
                                    <a class="btn btn-danger" data-toggle='modal' data-target="#mm<?php echo $row['technician_id']; ?>">
                                    <i class="far fa-trash-alt"></i></a>
                                    <div class="modal" id="mm<?php echo $row['technician_id']; ?>">
                                            ...
                                            <!-- Modal Header -->
                                               <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                  Are you sure you want to delete <b><?php echo $row['technician_name']; ?>? </b>
                                                </div>
                                                <!-- Modal footer -->
        ...
        {
            echo "There is no technician";
        }
        ?>
        <div class="float-right">
            <a href="inserttechnician.php"
...
<?php
    ...
    {
        $sql = "DELETE FROM technician WHERE
